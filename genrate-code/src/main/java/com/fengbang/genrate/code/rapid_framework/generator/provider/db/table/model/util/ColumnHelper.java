package com.fengbang.genrate.code.rapid_framework.generator.provider.db.table.model.util;
...
public class ColumnHelper {
	...
	public static String getNotRequiredHibernateValidatorExpression(Column c) {
		...
		if(DatabaseDataTypesUtils.isIntegerNumber(c.getJavaType())) {
			String javaType = DatabaseDataTypesUtils.getPreferredJavaType(c.getSqlType(), c.getSize(), c.getPrecision(), c.getDecimalDigits());
